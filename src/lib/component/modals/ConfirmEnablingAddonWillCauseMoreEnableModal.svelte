    ...
    <div class="modal-content">
      ...
      <div class="modal-footer flex-nowrap">
        <button
          ...
          on:click="{hide}">
          {$_('components.modals.confirm-enabling-addon-will-cause-more-enable.cancel')}
        </button>
        <button
          ...
          class:disabled="{loading}"
          on:click="{onYesClick}">
          {$_('components.modals.confirm-enabling-addon-will-cause-more-enable.yes')}
        </button>
      </div>
    </div>
  </div>
...
<script context="module">
  ...
  const dialogID = "enablingAddonWillCauseMoreEnableConfirmationModal";
